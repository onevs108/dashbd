					...
					<div class="ibox float-e-margins">
					    ...
					    <div class="ibox-content" style="display: block;">
					    	<div class="row">
					            <div class="col-sm-4">
									<div class="form-group">
										...
										<div class="col-sm-9">
											<c:choose>
												<c:when test="${USER.grade == 0}">
													<select name="status" id="operatorBroadContent" class="form-control">
														<option value="">--ALL--</option>
													<c:forEach items="${OperatorList}" var="operator">
														<option value="${operator.id}">${operator.name}</option>
													</c:forEach>
												...
												<c:otherwise>
													<select name="status" id="operatorBroadContent" class="form-control" disabled="disabled">
														<option value="">--ALL--</option>
														<c:forEach items="${OperatorList}" var="operator">
															<c:choose>
																<c:when test="${USER.operatorId == operator.id}">
								...
								<div class="col-sm-3">
									<div class="form-group">
										<label class="col-sm-5 control-label" for="status">BM-SC</label>
										<div class="col-sm-7">
											<select name="status" id="bmscBroadContent" class="form-control">
												<option value="">--ALL--</option>
											</select>
										</div>
									</div>	
					    	...
					    	<div class="row">
					            <div class="col-sm-12">
									<div class="form-group">
										<label class="col-sm-1 control-label" for="status">Year</label>
										<div class="col-sm-1">
											<select name="status" id="yearBroadContentS" class="form-control" style="width: 140%;">
												<option value="">--ALL--</option>
				                                <script>
													var myDate = new Date();
													var year = myDate.getFullYear();
													for(var i = 2016; i < year+5; i++){
														if(i == year){
														 	$("#yearBroadContentS").append('<option value="'+i+'" selected>'+i+'</option>');
														}else{
														 	$("#yearBroadContentS").append('<option value="'+i+'">'+i+'</option>');
														}
													}
												</script>
											</select>
										</div>
										<label class="col-sm-1 control-label" for="status">Month</label>
										<div class="col-sm-1">
											<select name="status" id="monthBroadContentS" class="form-control" style="width: 140%;">
												<option value="">--ALL--</option>
				                                <script>
													var myDate = new Date();
													var year = myDate.getFullYear();
													...
													for(var i = 1; i < 13; i++){
														if(i < 10){
															if(i == month){
															 	$("#monthBroadContentS").append('<option value="0'+i+'" selected>'+i+'</option>');
															}else{
															 	$("#monthBroadContentS").append('<option value="0'+i+'">'+i+'</option>');
															}
														}else{
															if(i == month){
															 	$("#monthBroadContentS").append('<option value="'+i+'" selected>'+i+'</option>');
															}else{
															 	$("#monthBroadContentS").append('<option value="'+i+'">'+i+'</option>');
															}
														}
													}
												</script>
										...
										<label class="col-sm-1 control-label" for="status">Day</label>
										<div class="col-sm-1">
											<select name="status" id="dayBroadContentS" class="form-control" style="width: 120%;">
												<option value="">--ALL--</option>
											</select>
										</div>
										<label class="col-sm-1 control-label" for="status"> ~ Year</label>
										<div class="col-sm-1">
											<select name="status" id="yearBroadContentE" class="form-control" style="width: 140%;">
												<option value="">--ALL--</option>
				                                <script>
													var myDate = new Date();
													var year = myDate.getFullYear();
													for(var i = 2016; i < year+5; i++){
														if(i == year){
															$("#yearBroadContentE").append('<option value="'+i+'" selected>'+i+'</option>');
														}else{
															$("#yearBroadContentE").append('<option value="'+i+'">'+i+'</option>');
														}
													}
												</script>
											</select>
										...
										<label class="col-sm-1 control-label" for="status">Month</label>
										<div class="col-sm-1">
											<select name="status" id="monthBroadContentE" class="form-control" style="width: 140%;">
												<option value="">--ALL--</option>
				                                <script>
													var myDate = new Date();
													var year = myDate.getFullYear();
													...
													for(var i = 1; i < 13; i++){
														if(i < 10){
															if(i == month){
															 	$("#monthBroadContentE").append('<option value="0'+i+'" selected>'+i+'</option>');
															}else{
															 	$("#monthBroadContentE").append('<option value="0'+i+'">'+i+'</option>');
															}
														}else{
															if(i == month){
															 	$("#monthBroadContentE").append('<option value="'+i+'" selected>'+i+'</option>');
															}else{
															 	$("#monthBroadContentE").append('<option value="'+i+'">'+i+'</option>');
															}
														}
													}
												</script>
										...
										<label class="col-sm-1 control-label" for="status">Day</label>
										<div class="col-sm-1">
											<select name="status" id="dayBroadContentE" class="form-control" style="width: 120%;">
												<option value="">--ALL--</option>
											</select>
										</div>
									</div>
					    	...
					    	<div class="row">
								<div class="col-sm-12">
									<div class="table-responsive">
										<table class="table table-bordered" id="broadCastTable"></table>
									</div>
								</div>
					        </div>
				        </div>
