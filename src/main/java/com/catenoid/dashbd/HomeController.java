...
//				menuHtml.append(currentMenu.equals(Const.MENU_PERMISSION_MGMT) ? "<li class=\"landing_link\">" : "<li>").append("<a href=\"/dashbd/resources/permission.do\"><i class=\"fa fa-lock\"></i> <span class=\"nav-label\">Permission Mgmt</span></a></li>");
				...
				menuHtml.append(currentMenu.equals(Const.MENU_MOOD_MONITORING) ? "<li class=\'landing_link\'>" : "<li>").append("<a href='/dashbd/mood/main.do'><i class='fa fa-th-large'></i> <span class='nav-label'>Mood Monitoring</span> <span class='fa arrow'></span></a></li>");
				menuHtml.append(currentMenu.equals(Const.MENU_SYSTEM_MGMT) ? "<li class=\'landing_link\'>" : "<li>").append("<a href='#' style='cursor:default'><i class='fa fa-desktop'></i> <span class='nav-label'>System Mgmt</span><span class='fa arrow'></span></a></li>");
...
//						menuHtml.append(currentMenu.equals(Const.MENU_PERMISSION_MGMT) ? "<li class=\"landing_link\">" : "<li>").append("<a href=\"/dashbd/resources/permission.do\"><i class=\"fa fa-lock\"></i> <span class=\"nav-label\">Permission Mgmt</span></a></li>");
					...
					else if (permission.getRole().equals(Const.ROLE_MOOD_MONITORING))
						menuHtml.append(currentMenu.equals(Const.MENU_MOOD_MONITORING) ? "<li class=\'landing_link\'>" : "<li>").append("<a href='/dashbd/mood/main.do'><i class='fa fa-th-large'></i> <span class='nav-label'>Mood Monitoring</span> <span class='fa arrow'></span></a></li>");
					else if (permission.getRole().equals(Const.ROLE_SYSTEM_MGMT)) {
						menuHtml.append(currentMenu.equals(Const.MENU_SYSTEM_MGMT) ? "<li class=\"landing_link\">" : "<li>").append("<a href=\"#\" style=\"cursor:default\"><i class=\"fa fa-th-large\"></i> <span class=\"nav-label\">System Mgmt</span><span class='fa arrow'></span></a></li>");
