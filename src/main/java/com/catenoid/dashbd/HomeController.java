	...
	private ResponseEntity<String> getMenuList(HttpServletRequest request) {
		...
		try {
			...
			if (user.getGrade() == Const.USER_GRADE_ADMIN) {
				...
				menuHtml.append(currentMenu.equals(Const.MENU_SYSTEM_DB_MGMT) ? "<li class=\"landing_link\">" : "<li>").append("<a href=\"/dashbd/resources/systemDbMgmt.do\">&nbsp;&nbsp;&nbsp;&nbsp;<i class=\"fa fa-bar-chart\"></i> <span class=\"nav-label\">DB Backup & Restore</span></a></li>");
